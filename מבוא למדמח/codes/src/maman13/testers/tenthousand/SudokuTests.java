package maman13.testers.tenthousand;
...
public class SudokuTests {
    ...
    private final static String path = "C:\\Users\\Amit\\Desktop\\Coding Stuff\\Python Codes\\Discord Bots\\Github\\OpenUniCourses";

    // #################### if FileNotFoundException occurs, set FULL PATH to solved_board.txt file here ####################
    private final static String PATH_TO_SUDOKU_BOARDS_FILE = path + "/solved_boards.txt";
