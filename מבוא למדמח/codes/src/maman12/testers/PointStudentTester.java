...
public class PointStudentTester
{
	public static void main(String[] args) 
	{
		...
		if (p0.getX() != 0 || p0.getY() != 0)
			System.out.println("\t ERROR -  constructor and getters expected (0,0) actual= (" + p0.getX() + "," + p0.getY() +")");
		else
			System.out.println("\t OK -  constructor and getters expected (0,0) actual=(" + p0.getX() + "," + p0.getY() +")");
		p0 = new Point(0,4); 
		if (p0.getX() != 0 || p0.getY() != 4)
			System.out.println("\t ERROR - constructor and getters expected (0.0,4) actual= (" + p0.getX() + "," + p0.getY() +")");
		else
			System.out.println("\t OK -  constructor and getters expected (0.0,4.0) actual=(" + p0.getX() + "," + p0.getY() +")");
		p0 = new Point(3,0); 
		if (p0.getX() != 3 || p0.getY() != 0)
			System.out.println("\t ERROR - constructor and getters expected (3,0.0) actual= (" + p0.getX() + "," + p0.getY() +")");
		else
			System.out.println("\t OK - constructor and getters expected (3,0.0) actual=(" + p0.getX() + "," + p0.getY() +")");

		p0 = new Point(3, 4);
		if (p0.getX() != 3 || p0.getY() != 4)
			System.out.println("\t ERROR - constructor and getters (x, y): expected(3,4); actual=" + p0);
		else 
			System.out.println("\t OK - constructor and getters (x, y): expected(3,4); actual=" + p0);

		System.out.println("testing copy constructor: ");

		Point p1 = new Point(p0);
		if (p1.getX() != 3 || p1.getY() != 4)
			System.out.println("\t ERROR - copy constructor (other p): expected(3,4) ; actual=" + p1);
		else 
			System.out.println("\t OK - copy constructor (other p): expected(3,4) ; actual=" + p1);
		...
		if (p0.getX() != 5 || p0.getY() != 4)
			System.out.println("\t ERROR - setX point was (3,4) set x to 5 expected (5,4) actual= (" + p0.getX() + "," + p0.getY() +")");
		else
			System.out.println("\t OK - setX point was (3,4) set x to 5 expected (5,4)  actual=(" + p0.getX() + "," + p0.getY() +")");
		p0 = new Point(3,4); 
		p0.setY(5);
		if (p0.getX() != 3 || p0.getY() != 5)
			System.out.println("\t ERROR - setY point was (3,4) set y to 5 expected (3,5) actual= (" + p0.getX() + "," + p0.getY() +")");
		else
			System.out.println("\t OK - setY point was (3,4) set y to 5 expected (3,5)  actual=(" + p0.getX() + "," + p0.getY() +")");

		System.out.println("testing toString:"); 

		Point p2 = new Point (4, 3);
		if(!(p2.toString().equals("(4,3)")))
			System.out.println("\t ERROR - p2.toString() expected (4,3) ; actual=" + p2.toString()) ;
		else
			System.out.println("\t OK - p2.toString() expected (4,3) ; actual=" + p2.toString()) ;
		...
		p0.move(3,4);
		if (p0.getX()!=3)
			System.out.println("\t ERROR - p0.move(3,4) for the point(0,0) "
			+ " should change x to be 3 while your coordinate x is: " + p0.getX());
		if (p0.getY()!=4)
			System.out.println("\t ERROR - p0.move(3,4) for the point(0,0) "
			+ " should change y to be 4 while your coordinate y is: " + p0.getY());
		else
			System.out.println("\t OK - p0.move(3,4) for the point(0,0) " + 
			"changed the point to (3,4) as expected");
